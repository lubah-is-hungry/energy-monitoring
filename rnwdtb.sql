...
--
-- Host: localhost    Database: renewable_energy_db
-- ------------------------------------------------------
...
CREATE TABLE `data_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_datalog_sensor` (`sensor_id`),
  CONSTRAINT `fk_datalog_sensor` FOREIGN KEY (`sensor_id`) REFERENCES `sensor` (`id`) ON DELETE CASCADE
...
CREATE TABLE `sensor` (
  ...
  `sensor_type` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ACTIVE',
  `calibration_date` date DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_sensor_energy_source` (`energy_source_id`),
  CONSTRAINT `fk_sensor_energy_source` FOREIGN KEY (`energy_source_id`) REFERENCES `energy_source` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-11-29  1:44:33
